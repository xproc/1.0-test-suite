...
Passed 810 of 813 tests (99.63%) on 16 May 2015 at 05:43p.
...
|Version|0.95-5 (public beta) with SaxonXSLTConnector(Saxon HE 9.6.0.5)|PSVI Supported|false
|=============================================
...
http://www.xml-project.com/files/xproc-tests/additional-tests/data-csv.xml

[role="pass"]
=== PASS Test extensions-001: Test presence of loaded extension step
http://www.xml-project.com/files/xproc-tests/additional-tests/extensions-001.xml

[role="pass"]
=== PASS Test extensions-002: Test presence of loaded extension function
http://www.xml-project.com/files/xproc-tests/additional-tests/extensions-002.xml
